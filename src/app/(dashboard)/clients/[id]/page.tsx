...
import { cn, STATUS_COLORS, OPP_STATUS_COLORS, formatDate, formatCurrency } from "@/lib/utils";
        ...
        <div className="space-y-4">
          ...
          <Card>
            <CardContent className="p-4">
              <div className="rounded-lg bg-slate-100 h-32 flex items-center justify-center text-sm text-slate-400">
                📍 {org.city}, {org.country}
                <br />
                {org.lat && org.lng && (
